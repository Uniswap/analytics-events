...
export enum InterfaceElementName {
  ...
  EXTENSION_LAUNCH_DOWNLOAD_CONNECTOR = 'extension-launch-download-connector',
  EXTENSION_LAUNCH_GETTING_STARTED = 'extension-launch-getting-started',
  EXTENSION_LAUNCH_WIDE_MODAL = 'extension-launch-wide-modal',
  ...
  UNISWAP_WALLET_LANDING_PAGE_DOWNLOAD_BUTTON = 'uniswap-wallet-landing-page-download-button',
