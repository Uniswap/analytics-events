...
export enum InterfaceEventName {
  ...
  UNISWAP_WALLET_EXTENSION_DOWNLOAD_OPENED = 'Uniswap Wallet Extension Download Opened',
  UNISWAP_WALLET_GETTING_STARTED_OPENED = 'Uniswap Wallet Getting Started Modal Opened',
  UNISWAP_WALLET_LEARN_MORE_CLICKED = 'Uniswap Wallet Learn More Clicked',
  UNISWAP_WALLET_MICROSITE_OPENED = 'Uniswap Wallet Microsite Opened',
  UNISWAP_WALLET_PROMO_CLOSED = 'Uniswap Wallet Promotional Modal Closed',
