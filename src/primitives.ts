...
export enum EventName {
  ...
  TAX_SERVICE_BANNER_CTA_CLICKED = 'Tax Service Learn More Button Clicked',
  TAX_SERVICE_COINTRACKER_CLICKED = 'Tax Service CoinTracker Link Clicked',
  TAX_SERVICE_TOKENTAX_CLICKED = 'Tax Service TokenTax Link Clicked',
